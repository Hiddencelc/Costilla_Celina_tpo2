...
public class MascotaJpaController implements Serializable {
    ...
    // creo mi constructor para mi unidad de persistencia pasando el nombre.
    public MascotaJpaController() {
        emf = Persistence.createEntityManagerFactory("PeluqueriaCanina_Tpo2PU");
    }
...
//          EntityManager em = getEntityManager();
//          Query query = em.createNativeQuery("SELECT MAX(id) as Id from mascota");
//          List id= query.getResultList();
//          String idIncremental= id.toString();
//          return idIncremental;
//    }
      public Integer idIncrementable(){
          EntityManager em = getEntityManager();
          Query query = em.createNativeQuery("SELECT MAX(id) as Id from mascota");
